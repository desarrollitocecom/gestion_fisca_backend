...
router.get("/",permisoAutorizacion(["all_system_access", "read_mc"]),getAllMedidasComplementariasHandler);
router.get("/:id",permisoAutorizacion(["all_system_access", "read_mc"]),getMedidaComplementariaHandler);
