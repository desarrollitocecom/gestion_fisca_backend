...
const createControlActaHandler = async (req, res) => {
    const { fecha_laburo, nro_actas_inicio, observaciones_inicio, id_encargado, id_inspector } = req.body;
...
module.exports = { updateNCHandler, allNCHandler, getCodigos, sendDetalle, getAllUsersforControlActasHandler, createControlActaHandler };
