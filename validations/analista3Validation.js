...
const validateAnalista3 = (body) => {
    const errors = [];
    const {
        nro_descargo, fecha_descargo, id_nc, id_analista_3
    } = body;
    ...
    if (!id_analista_3) errors.push('El campo id_analista_3 es requerido');
...
module.exports = { validateAnalista3 };
