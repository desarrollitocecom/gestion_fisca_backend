...
const { getNCforInstructiva, getNCforAnalista, getNCforDigitador } = require("./api/v1/controllers/ncController");
const { getIFIforAnalista2Controller, getIFIforAR1Controller, getIFIforAR2Controller } = require("./api/v1/controllers/informeFinalController");
const { getRSAforAnalista3Controller, getRSAforAR3Controller, getRSAforAnalista5Controller } = require("./api/v1/controllers/rsaController")
const { getRSGforAnalista4Controller, getRSGforGerenciaController, getRSGforAnalista5Controller } = require("./api/v1/controllers/rsgController")
const { getRGforAnalista5Controller } = require("./api/v1/controllers/rgController")
