...
const {createRSG2Handler, getAllRSG2forAR2Handler, getAllIFIforAR2Handler, createRSAHandler, createRSG2RectificacionHandler}=require('../handlers/areaResolutiva2Handler');
...
router.patch("/RSA-rectificacion/:id",permisoAutorizacion(["all_system_access", "create_AResolutiva1"]),uploadResoSG,createRSG2RectificacionHandler);
