...
const createInformeFinalController = async ({ nro_ifi, fecha, documento_ifi, tipo, id_evaluar, id_descargo_ifi, id_nc }) => {
    ...
    try {
        ...
        if (!checking) {
            ...
            const response = await IFI.create({ nro_ifi, fecha, documento_ifi: documento_ifi_path, tipo, id_evaluar, id_descargo_ifi, id_nc });
...
const updateInformeFinalController = async ({ id, nro_ifi, fecha, documento_ifi, tipo, id_evaluar, id_descargo_ifi,id_nc }) => {
    let documento_ifi_path
    try {
